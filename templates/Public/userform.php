...
<script>
	...
	function validateForm() {
		...
		//if ( job == null || job == "" ) {
			alert( "Job of worker must be filled out" );
			return false;
		//}
...
"; 
		 ...
		 { 
			...
			$sql="INSERT INTO `users`(`First Name`,`Last Name`,`Address`,`Gender`,`Contact Number`,`email`,`Password`) VALUES ('$fname','$lname','$addrs','$gender','$phno','$email','$pass','$cpass')";
			//close the connection
			mysqli_query( $connect, $sql );
			$sql_login="INSERT INTO `login` (`username`,`password`) VALUES ('$email','$pass')";
	...
	<div class="row">
		<div class="col-md-12">
			<form name="register" action="" method="POST" >
				<fieldset>
					<legend>
						<h3 style="padding-top: 25px;">User Registration Form </h3>
					</legend>
