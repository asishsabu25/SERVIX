    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Servex</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a href="index1.html">Registration</a>
                    </li>
                    <li>
				...
				<!-- <li class="dropdown">
                   ...
                   <!--   <li>
                   <form name="studentlogin" action="registrationform.php" method="POST">
                    <button type="submit" name="login" class="btn btn-primary">Sign Up</button>

                    </form>
                    </li>
                    <li>
                    <form name="studentlogin" action="studentlogin.php" method="POST">
