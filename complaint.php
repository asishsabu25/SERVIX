...
#navbar a.active {
  ...
  <a class="active" href="index.php">SERVIX</a>
                    ...
                    <h2>Complaints</h2> 
                    <p> Please provide your Complaints below: </p>
                    <form role="form" method="post" id="reused_form">
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                <label for="name">Enter Worker Id:</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control" type="textarea" name="complaints" id="complaints" placeholder="Your complaints" maxlength="6000" rows="7"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 form-group">
...
{
$wid=$_POST['workerid'];
$cmplnt=$_POST['complaints'];
$from=$_POST['name'];
$email=$_POST['email'];

$sql="insert into complaint values('$wid','$cmplnt','$from','$email')";
