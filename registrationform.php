...
"; 
        ...
        $sql = "INSERT INTO `studenttable` (`FName`, `LName`, `DOB`, `Addrs`, `Gender`, `PhNo`, `Eid`, `Pass`,`Course`) VALUES ('$fname','$lname','$dob','$addrs','$gender','$phno','$email','$pass','$course')";
			//close the connection
			mysqli_query( $connect, $sql );
            
            $sql_login="INSERT INTO `login` (`name`,`eid`,`pass`,`role`) VALUES ('$fname','$email','$pass','$r')";
