...
<body>
    ...
    <div class="wrapper">
        <div class="button" top:340; left:570" onClick="document.body.classList.add('active')">
        ...
        <div class="popup">
            ...
            <div class="content">
                <div class="content-wrapper">
                    <p class="try-again" onClick="location.href='studentregistration.php'">Student</p>
                    <p class="try-again" onClick="location.href='parentregistration.php'">Parent</p>
                    <p class="try-again" onClick="location.href='teacherregistration.php'">Teacher</p>
                    <p class="try-again" onClick="location.href='hodregistration.php'">HOD</p>
                    <p class="try-again" onClick="location.href='principal registration.php'">Principal</p>
                    <p class="try-again" onClick="location.href='index.php'">Back</p>
                </div>
            </div>
        </div>
    </div>
    
<div class="button" style=" top:340; left:570" onclick="location.href='index.php'">
